...
def printlogo():
    ...
    pc.printout("Uploaded  : by Mohammed Ahmed Faiz\n", pc.YELLOW)
    pc.printout("Instagram : https://www.instagram.com/mohammed_ahmedfaiz7\n")
    pc.printout("github    : https://github.com/MohammedFaiz06\n")
    pc.printout("Facebook  : https://www.facebook.com/maf1704\n")
